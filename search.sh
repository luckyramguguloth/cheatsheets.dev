...
print_help() {
  ...
  echo -e "  ${COLOR_YELLOW}--list <cat>${COLOR_RESET}     List cheatsheets in a category (dev, devops, gaming, hardware, ai-ml, systems, it-support)"
...
cmd_list() {
  ...
  for dir in "${CATEGORY_DIRS[@]}"; do
    ...
    case "$dir" in
      ...
      systems)    emoji="🏢"; label="Systems Engineering" ;;
      it-support) emoji="🛠️ "; label="IT Support & Disaster Recovery" ;;
    esac
